      ...
      <div class="container marketing">
		...
		<c:forEach items="${peliculas}" var="pelicula">
          <div class="col-xs-12 col-sm-6 col-md-3">
            <img src="${urlPublic}/images/${pelicula.imagen}" alt="Generic placeholder image" class="img-rounded"  width="150" height="200">            
            <h4>${pelicula.titulo}</h4>
            <h4>
              <span class="label label-default">${pelicula.clasificacion}</span>
              <span class="label label-default">${pelicula.duracion} mins.</span>
